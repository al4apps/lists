...
@Composable
private fun SumRaisedText(raisedSum: Long) {
    Text(
...
@Composable
private fun RaisingText(text: String, modifier: Modifier = Modifier) {
    Text(
        text,
        fontSize = 12.sp,
...
@Composable
private fun SumToRaiseText(toRaise: Long, modifier: Modifier = Modifier) {
    Text(
        modifier = modifier,
...
private fun FundModel.raisedFraction(): Float {
    return toRaise?.let {
